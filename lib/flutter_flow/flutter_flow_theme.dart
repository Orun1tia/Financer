...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF3358FF);
  late Color secondary = const Color(0xFF9142ED);
  late Color tertiary = const Color(0xFFABBAFF);
  late Color alternate = const Color(0xFFCDABF4);
  late Color primaryText = const Color(0xFF111417);
  late Color secondaryText = const Color(0xFFF1F4F8);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF616161);
  late Color accent2 = const Color(0xFFB3B3B3);
  late Color accent3 = const Color(0xFFD7D5D5);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryBackground = const Color(0xFF252729);
